              ...
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                <form method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-outline mb-4">
                    <input name="destination" type="text" id="form2Example17" class="form-control" placeholder="Destination" />
                  ...
                  <div class="pt-1 mb-4">
                    <button name="submit" class="btn btn-dark  btn-block"  style="background-color: #06576c" type="submit">Add</button>
